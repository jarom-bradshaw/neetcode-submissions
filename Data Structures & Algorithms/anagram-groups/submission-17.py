class Solution:
    def groupAnagrams(self, strs: List[str]) -> List[List[str]]:
        ...
        for string in strs:
            ...
            hashmap.setdefault(key,[]) # Strings are iterable, but immutable. so we use sorted, instead of .sort(), which modifies a value, instead of returning a val unlike sorted.
